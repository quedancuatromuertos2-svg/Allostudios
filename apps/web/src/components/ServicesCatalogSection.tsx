...
const services = [
  ...
  { key: 'Web profesional', d: '<circle cx="12" cy="12" r="10"/><path d="M2 12h20"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/>', desc: 'Web premium a medida, rapidísima y optimizada para convertir visitas en clientes.', price: '400 € + 49 €/mes' },
