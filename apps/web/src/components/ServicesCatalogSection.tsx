...
const services = [
  ...
  { key: 'Asistente IA 24/7', d: '<path d="M12 8V4H8"/><rect width="16" height="12" x="4" y="8" rx="2"/><path d="M2 14h2"/><path d="M20 14h2"/><path d="M15 13v2"/><path d="M9 13v2"/>', desc: 'Un asistente que responde tu WhatsApp 24/7: horarios, precios, dudas y peticiones de cita. Te avisa cuando hay que hablar contigo.', price: 'Desde 49 €/mes' },
