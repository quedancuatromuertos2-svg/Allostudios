...
export default function CristalHero() {
  ...
  useEffect(() => {
    ...
    function medir() {
      ...
      // el cartel centra la caja de línea (line-height 1); el 'middle' del canvas queda ~0.22 em más abajo: se corrige
      tx.fillStyle = 'rgba(10,8,6,.86)'; tx.fillText('allo.', movil ? W * .5 : W * .75, (movil ? H * .14 : H * .52) - tam * .22)
