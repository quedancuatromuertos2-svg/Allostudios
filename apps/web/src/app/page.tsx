...
/*  Home (19/09/2026): tres packs vendidos como productos, cada capítulo construido como una
    oferta (resultado → qué lleva con su valor → esfuerzo del cliente → precio sin riesgo → dudas).
    Las páginas web sueltas viven en /webs y los servicios sueltos en /servicios, con el diseño
    de la home anterior.                                                                          */
