        ...
        <div className="prose prose-sm max-w-none text-dim leading-relaxed space-y-8">
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1 mt-2">
              <li><strong>Packs</strong> (Estándar, Pro, Max) y <strong>webs</strong> (Arranque, Pro, Cinematográfica): cuota mensual con un <strong>compromiso de permanencia de 12 meses</strong> desde la fecha de contratación. Transcurridos los 12 meses, la suscripción continúa mes a mes sin permanencia.</li>
